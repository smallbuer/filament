 ...
 *
 *     void init() {
 *         CameraManipulator::Properties props = { .viewport = {1024, 768} };
 *         manip = CameraManipulator::create(camutils::Mode::ORBIT, props);
 *     }
 *
...
public:
     ...
     *
     * To prevent a proliferation of setters and getters, all user-controlled properties are bundled
     * into this POD structure. Most of these automatically fall back to reasonable default values
     * if they are zero-filled.
     */
    struct Properties {
